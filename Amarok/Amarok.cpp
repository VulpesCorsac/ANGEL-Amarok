...
void Amarok::on_plot_1_Moved(QMouseEvent *event) const
{
...
void Amarok::on_plot_2_Moved(QMouseEvent *event) const
{
...
void Amarok::on_plot_1_Pressed(QMouseEvent *event)
{
    printLogMsg("Mouse was pressed on plot 1", this->logMode == "All");

    return;
}

void Amarok::on_plot_2_Pressed(QMouseEvent *event)
{
    printLogMsg("Mouse was pressed on plot 2", this->logMode == "All");

    return;
}

void Amarok::on_plot_1_Released(QMouseEvent *event)
{
    printLogMsg("Mouse was released on plot 1", this->logMode == "All");

    return;
}

void Amarok::on_plot_2_Released(QMouseEvent *event)
{
    printLogMsg("Mouse was released on plot 2", this->logMode == "All");

    return;
}

void Amarok::on_plot_1_DoubleClicked(QMouseEvent *event)
{
    if (this->doubleClick1 == 0) {
        this->xSelectionMin1 = ui->customPlot_1->xAxis->pixelToCoord(event->pos().x());
        this->ySelectionMin1 = ui->customPlot_1->yAxis->pixelToCoord(event->pos().y());
    }
    if (this->doubleClick1 == 1) {
        this->xSelectionMax1 = ui->customPlot_1->xAxis->pixelToCoord(event->pos().x());
        this->ySelectionMax1 = ui->customPlot_1->yAxis->pixelToCoord(event->pos().y());

        ui->customPlot_1->xAxis->setRange(this->xSelectionMin1, this->xSelectionMax1);
        ui->customPlot_1->yAxis->setRange(this->ySelectionMin1, this->ySelectionMax1);
        ui->customPlot_1->replot();
    }

    printLogMsg("Mouse was doubleclicked on plot 1 for the " + QString::number(this->doubleClick1 + 1) + " time", this->logMode == "All");

    this->doubleClick1 = (this->doubleClick1 + 1) % 2;

    return;
}

void Amarok::on_plot_2_DoubleClicked(QMouseEvent *event)
{
    if (this->doubleClick2 == 0) {
        this->xSelectionMin2 = ui->customPlot_2->xAxis->pixelToCoord(event->pos().x());
        this->ySelectionMin2 = ui->customPlot_2->yAxis->pixelToCoord(event->pos().y());
    }
    if (this->doubleClick2 == 1) {
        this->xSelectionMax2 = ui->customPlot_2->xAxis->pixelToCoord(event->pos().x());
        this->ySelectionMax2 = ui->customPlot_2->yAxis->pixelToCoord(event->pos().y());

        ui->customPlot_2->xAxis->setRange(this->xSelectionMin2, this->xSelectionMax2);
        ui->customPlot_2->yAxis->setRange(this->ySelectionMin2, this->ySelectionMax2);
        ui->customPlot_2->replot();
    }

    printLogMsg("Mouse was doubleclicked on plot 2 for the " + QString::number(this->doubleClick2 + 1) + " time", this->logMode == "All");

    this->doubleClick2 = (this->doubleClick2 + 1) % 2;
...
void Amarok::init()
{
    ...
    connect(ui->customPlot_1, SIGNAL(mouseMove(QMouseEvent*)), this, SLOT(on_plot_1_Moved(QMouseEvent*)));
    connect(ui->customPlot_2, SIGNAL(mouseMove(QMouseEvent*)), this, SLOT(on_plot_2_Moved(QMouseEvent*)));

    connect(ui->customPlot_1, SIGNAL(mousePress(QMouseEvent*)), this, SLOT(on_plot_1_Pressed(QMouseEvent*)));
    connect(ui->customPlot_2, SIGNAL(mousePress(QMouseEvent*)), this, SLOT(on_plot_2_Pressed(QMouseEvent*)));

    connect(ui->customPlot_1, SIGNAL(mouseRelease(QMouseEvent*)), this, SLOT(on_plot_1_Released(QMouseEvent*)));
    connect(ui->customPlot_2, SIGNAL(mouseRelease(QMouseEvent*)), this, SLOT(on_plot_2_Released(QMouseEvent*)));

    connect(ui->customPlot_1, SIGNAL(mouseDoubleClick(QMouseEvent*)), this, SLOT(on_plot_1_DoubleClicked(QMouseEvent*)));
    connect(ui->customPlot_2, SIGNAL(mouseDoubleClick(QMouseEvent*)), this, SLOT(on_plot_2_DoubleClicked(QMouseEvent*)));
...
bool Amarok::checkRange(const double &R) const
{
    ...
    if (this->lockInAmplifier->getLockInAmplifierModel() == "RS844")
        ans = true;
...
{
    X = R * cos(Theta*3.1415926/180);
    Y = R * sin(Theta*3.1415926/180);
